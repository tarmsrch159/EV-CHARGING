  ...
  try {
    ...
    if (!tbl_temporary1.code) {
      ...
      if (tbl_temporary1.data.length > 0) {
        var xlicense_plate_truck =
          tbl_temporary1.data[0].veh_license_number.replace("-", "");
        ...
        if (tbl_temporary1.data[0].ord_type_code == "otyp-9999999999999") {
          ...
          xnumber = tbl_temporary1.data[0].ord_code
            .toString()
            .replace("odr-", "")
            .substr(0, 9);
        } else {
          ...
          if (tbl_temporary1.data[0].veh_sub_license_number != "") {
            if (tbl_temporary1.data[0].veh_sub_license_number != "N/A") {
              xlicence_plate_second_trailer =
                tbl_temporary1.data[0].veh_sub_license_number.replace("-", "");
              xlicense_plate_trailer =
                tbl_temporary1.data[0].veh_sub_license_number.replace("-", "");
            }
          }
        } else {
        ...
        var xlstart = moment(tbl_temporary1.data[0].loading_start_dt)
          .add("Hours", 0)
          .format("YYYY-MM-DDTHH:mm:ss");
        var xlend = moment(tbl_temporary1.data[0].loading_end_dt)
          .add("Hours", 0)
          .format("YYYY-MM-DDTHH:mm:ss");
        ...
        var xunstart = moment(tbl_temporary1.data[0].unloading_start_dt)
          .add("Hours", 0)
          .format("YYYY-MM-DDTHH:mm:ss");
        var xunend = moment(tbl_temporary1.data[0].unloading_end_dt)
          .add("Hours", 0)
          .format("YYYY-MM-DDTHH:mm:ss");
          ...
          if (tbl_temporary2.data.length > 0) {
            ...
            for (var itm = 0; itm <= tbl_temporary2.data.length - 1; itm++) {
              ...
              var xmaterial_number =
                tbl_temporary2.data[itm].itm_material_number;
              var xquantity = tbl_temporary2.data[itm].item_quantity;
              var xcompartment_number =
                tbl_temporary2.data[itm].veh_compartment_number;
              ...
              await axios
                ...
                .then((response) => {
                  ...
                  if (response.data.success == true) {
                    ...
                    console.log(
                      ord_code,
                      "เกิดข้อผิดพลาดในตอนส่งข้อมูล TMP, TMP Reject",
                    );
                    return false;
                  }
                })
            ...
            console.log(
              ord_code,
              "ไม่พบข้อมูล Item ใน Order เพื่อส่งไปยัง TMP",
            );
            return false;
          }
        } else {
          ...
          await axios
            ...
            .then((response) => {
              ...
              if (response.data.success == true) {
                ...
                console.log(
                  ord_code,
                  "เกิดข้อผิดพลาดในตอนส่งข้อมูล TMP, Accept TMP Reject",
                );
                return false;
              }
            })
          ...
          await axios
            ...
            .then((response) => {
              ...
              if (response.data.success == true) {
                ...
                console.log(
                  ord_code,
                  "เกิดข้อผิดพลาดในตอนส่งข้อมูล TMP, Decline TMP Reject",
                );
                return false;
              }
            })
    ...
    if (!tbl_temporary1.code) {
      ...
      if (tbl_temporary1.data.length > 0) {
        ...
        var xgsap_shipments_number =
          tbl_temporary1.data[0].gsap_shipments_number;
        var xgsap_order_type_code = tbl_temporary1.data[0].gsap_order_type_code;
        //vehicleSingletruckNoTrailer
        //vehicleRigidTruckWithTrailer
        //vehicleTruckTrailerCombination
        ...
        if (!tbl_temporary2.code) {
          if (tbl_temporary2.data.length > 0) {
            ...
            for (var itm = 0; itm <= tbl_temporary2.data.length - 1; itm++) {
              ...
              //No-VMI
              if (
                tbl_temporary1.data[0].ord_type_code == "otyp-9999999999999"
              ) {
              ...
              await axios
                ...
                .then((response) => {
                  ...
                  if (response.data.success == true) {
                    console.log(
                      ord_code,
                      "postCloseRedirectOrder2Tmp TMP Complete",
                    );
                    return true;
                  } else {
                    console.log(
            ...
            console.log(
              ord_code,
              "ไม่พบข้อมูล Redirect ใน Order เพื่อส่งไปยัง TMP",
            );
            return false;
          }
        } else {
              ...
              await axios
                ...
                .then((response) => {
                  ...
                  if (response.data.success == true) {
                    console.log(
                      ord_code,
                      "postCloseDischargedOrder2Tmp TMP Complete",
                    );
                    return true;
                  } else {
                    console.log(
  ...
  try {
    ...
    if (!tbl_temporary.code) {
      if (tbl_temporary.data.length > 0) {
        ...
        xresult[0].itm_material_number =
          tbl_temporary.data[0].itm_material_number;
        return xresult;
      } else {
        return xresult;
      }
...
exports.getCustomerInformationWithItem = async (
  lic_code,
  ptrl_number,
  itm_material_number,
) => {
  ...
  try {
    ...
    await axios
      ...
      .then(async (response) => {
        ...
        let tbl_temporary0043 = await pgConn.execute(
          dbPrefix + lic_code,
          script0043,
          config.connectionString(),
        );
        ...
        let tbl_temporary0044 = await pgConn.execute(
          dbPrefix + lic_code,
          script0044,
          config.connectionString(),
        );
        ...
        if (response.data.transport.length > 0) {
          for (
            var xshipment = 0;
            xshipment <= response.data.transport.length - 1;
            xshipment++
          ) {
            console.log(
              xshipment,
              response.data.transport.length - 1,
              response.data.transport[xshipment].number,
              response.data.transport[xshipment].owner,
            );
            //get only non-vmi
            if (response.data.transport[xshipment].owner == "No-VMI orders") {
              ...
              try {
                ...
                var tprn_information = JSON.stringify(
                  response.data.transport[xshipment],
                );
                var tprn_result = "";
                var tprn_remark = response.data.transport[xshipment].owner;
                var ist_dt = moment(
                  response.data.transport[xshipment].timestamp,
                ...
                let tbl_temporary0xxr = await pgConn.execute(
                  dbPrefix + lic_code,
                  script0r,
                  config.connectionString(),
                );
                ...
                console.log(
                  ...
                  "save log Non-VMI-Order is error.",
                );
              }

              //qualifier
              if (
                response.data.transport[xshipment].qualifier ==
                "tour.assigned.cancelled"
              ) {
                let script0 = ``;
                ...
                if (!tbl_temporary0.code) {
                  if (tbl_temporary0.data.length > 0) {
                    ...
                    //checked for change
                    try {
                      gsap_order_status = response.data.transport[
                        xshipment
                      ].shipments[0].parameters.filter(
                        (x) => x.qualifier == "gsap_status",
                      )[0].value;

                      if (
                        gsap_order_status.toString().toUpperCase() == "C" ||
                        response.data.transport[xshipment].status == "C"
                      ) {
                        if (
                          response.data.transport[xshipment].qualifier ==
                          "tour.assigned.change"
                        ) {
                          if (tbl_temporary0.data[0].ord_code != "") {
                            ...
                            if (
                              response.data.transport[xshipment].shipments
                                .length > 0
                            ) {
                              var shipments =
                                response.data.transport[xshipment].shipments;
                              ...
                              for (
                                var xpr = 0;
                                xpr <= shipments[0].parameters.length - 1;
                                xpr++
                              ) {
                                //debugger
                                if (
                                  shipments[0].parameters[xpr].qualifier ==
                                  "order_type"
                                ) {
                                  gsap_order_type_code =
                                    shipments[0].parameters[xpr].value;
                                } else if (
                                  shipments[0].parameters[xpr].qualifier ==
                                  "gsap_status"
                                ) {
                                ...
                                if (xpr == shipments[0].parameters.length - 1) {
                                  for (
                                    ...
                                    if (shipments[0].station.length >= 2) {
                                      ...
                                      for (
                                        var xss = 0;
                                        xss <= shipments[0].station.length - 1;
                                        xss++
                                      ) {
                                        if (
                                          shipments[0].station[xss].type ==
                                          "loading"
                                        ) {
                                          dpo_number =
                                            shipments[0].station[xss]
                                              .loading_name;
                                          xdpo_information =
                                            await this.getDepotInformation(
                                              lic_code,
                                              dpo_number,
                                            );
                                          dpo_code =
                                            xdpo_information[0].dpo_code;
                                          debugger;
                                        } else if (
                                          shipments[0].station[xss].type ==
                                          "unloading"
                                          ...
                                          for (
                                            var xitm = 0;
                                            xitm <=
                                            shipments[0].items.length - 1;
                                            xitm++
                                          ) {
                                            itm_material_number =
                                              shipments[0].items[xitm]
                                                .material_number;
                                            xcustomer_information =
                                              await this.getCustomerInformationWithItem(
                                                lic_code,
                                                ptrl_number,
                                                itm_material_number,
                                              );
                                            ...
                                            let itm_short_desc =
                                              shipments[0].items[xitm]
                                                .short_description;
                                            let xitm_information =
                                              await this.getItemInformation(
                                                lic_code,
                                                itm_material_number,
                                              );
                                            itm_code =
                                              xitm_information[0].itm_code;
                                            itm_unit_code =
                                              xitm_information[0].itm_unit_code;
                                            itm_material_number =
                                              xitm_information[0]
                                                .itm_material_number;
                                            ...
                                            try {
                                              if (
                                                shipments[0].items[xitm]
                                                  .quantities[0].qualifier ==
                                                "dimension.volume"
                                              ) {
                                                item_quantity = parseFloat(
                                                  shipments[0].items[xitm]
                                                    .quantities[0].value,
                                                );
                                              }
                    ...
                    //insert to tbl_order
                    if (
                      response.data.transport[xshipment].shipments.length > 0
                    ) {
                      debugger;
                      var shipments =
                        response.data.transport[xshipment].shipments;
                      ...
                      let comment = shipments[0].comment;
                      let document_reference =
                        response.data.transport[xshipment].document_reference;
                      let ord_dt = moment(
                        response.data.transport[xshipment].timestamp,
                      )
                        .add("Hours", 0)
                      ...
                      for (
                        ...
                        //debugger
                        if (
                          shipments[0].parameters[xpr].qualifier == "order_type"
                        ) {
                          gsap_order_type_code =
                            shipments[0].parameters[xpr].value;
                        } else if (
                          ...
                          for (
                            ...
                            if (shipments[0].station.length >= 2) {
                              ...
                              for (
                                ...
                                if (
                                  shipments[0].station[xss].type == "loading"
                                ) {
                                  dpo_number =
                                    shipments[0].station[xss].loading_name;
                                  xdpo_information =
                                    await this.getDepotInformation(
                                      lic_code,
                                      dpo_number,
                                  ...
                                  shipments[0].station[xss].type == "unloading"
                                ) {
                                  ptrl_number =
                                    shipments[0].station[xss].loading_name;
                                  ...
                                  for (
                                    var xitm = 0;
                                    xitm <= shipments[0].items.length - 1;
                                    xitm++
                                  ) {
                                    itm_material_number =
                                      shipments[0].items[xitm].material_number;
                                    xcustomer_information =
                                      await this.getCustomerInformationWithItem(
                                        lic_code,
                                        ptrl_number,
                                    ...
                                    ptrl_code =
                                      xcustomer_information[0].ptrl_code;
                                    ord_customer_code =
                                      xcustomer_information[0].ptrl_code;
                                    ord_customer_name =
                                      xcustomer_information[0].ptrl_desc;
                                    ord_customer_number =
                                      xcustomer_information[0].ptrl_number;
                                    petrol_group_code =
                                      xcustomer_information[0].ptrl_group_code;
                                    ptrl_tank_code =
                                      xcustomer_information[0].ptrl_tank_code;
                                    ...
                                    if (xitm == 0) {
                                      ...
                                      let tbl_temporary1 = await pgConn.execute(
                                        dbPrefix + lic_code,
                                        script1,
                                        config.connectionString(),
                                      );
                                    ...
                                    let item_quantity = 0;
                                    let pos_number =
                                      shipments[0].items[xitm].pos_number;
                                    let itm_desc =
                                      shipments[0].items[xitm].description;
                                    let itm_short_desc =
                                      shipments[0].items[xitm]
                                        .short_description;
                                    let xitm_information =
                                    ...
                                    itm_unit_code =
                                      xitm_information[0].itm_unit_code;
                                    itm_material_number =
                                      xitm_information[0].itm_material_number;

                                    try {
                                      if (
                                        shipments[0].items[xitm].quantities[0]
                ...
                if (ord_code != undefined && ord_code != "") {
                  ...
                  let tbl_temporary5 = await pgConn.execute(
                    dbPrefix + lic_code,
                    script5,
                    config.connectionString(),
                  );
...
exports.postSyncNonVMIOrderWithNumber = async (lic_code, order_no) => {
  try {
    ...
    if (order_no == "") {
      ...
      let tbl_temporary0xx = await pgConn.get(
        dbPrefix + lic_code,
        script,
        config.connectionString(),
      );
      if (!tbl_temporary0xx.code) {
        ...
        if (tbl_temporary0xx.data.length > 0) {
          console.log(
            "Order count:",
            order_no,
            tbl_temporary0xx.data.length - 1,
          );
          ...
          for (
            var xshipment = 0;
            xshipment <= tbl_temporary0xx.data.length - 1;
            xshipment++
          ) {
            var transport = [];
            transport = JSON.parse(
              tbl_temporary0xx.data[xshipment].tprn_information,
            );
            //qualifier
            if (transport.qualifier == "tour.assigned.cancelled") {
              ...
              if (!tbl_temporary0.code) {
                if (tbl_temporary0.data.length > 0) {
                  ...
                  try {
                    gsap_order_status =
                      transport.shipments[0].parameters.filter(
                        (x) => x.qualifier == "gsap_status",
                      )[0].value;
                      ...
                      if (transport.qualifier == "tour.assigned.change") {
                        if (tbl_temporary0.data[0].ord_code != "") {
                          ...
                          if (transport.shipments.length > 0) {
                            ...
                            let comment = shipments[0].comment;
                            let document_reference =
                              transport.document_reference;
                            let ord_dt = moment(transport.timestamp)
                              .add("Hours", 0)
                              .format("YYYY-MM-DD HH:mm:ss");
                            let req_dt = moment(
                              transport.end_date + " " + transport.end_time,
                            )
                              .add("Hours", 0)
                              .format("YYYY-MM-DD HH:mm:ss");
                            let gsap_order_type_code = "ZOR";
                  ...
                  if (transport.shipments.length > 0) {
                    ...
                    for (
                      ...
                      if (
                        ...
                        shipments[0].parameters[xpr].qualifier == "gsap_status"
                      ) {
                              ...
                              if (shipments[0].station[xss].type == "loading") {
                                ...
                                for (
                                  ...
                                  let itm_desc =
                                    shipments[0].items[xitm].description;
                                  let itm_short_desc =
                                    shipments[0].items[xitm].short_description;
                                  let xitm_information =
                                    await this.getItemInformation(
                                      lic_code,
                                      itm_material_number,
  ...
  try {
    ...
    if (!tbl_temporary1.code) {
      ...
      if (tbl_temporary1.data.length > 0) {
        ...
        let tbl_temporaryx00 = await pgConn.get(
          dbPrefix + lic_code,
          scriptx00,
          config.connectionString(),
        );
        ...
        if (!tbl_temporaryx00.code) {
          if (tbl_temporaryx00.data.length > 0) {
            ...
            for (var x00 = 0; x00 <= tbl_temporaryx00.data.length - 1; x00++) {
              ...
              if (
                tbl_temporaryx00.data[x00].ord_type_code == "otyp-9999999999999"
              ) {
                xgsap_order_status =
                  tbl_temporaryx00.data[x00].gsap_order_status;
                xgsap_order_type_code =
                  tbl_temporaryx00.data[x00].gsap_order_type_code;
                ...
                xgsap_shipments_number = "";
                xshipments_code =
                  "692" + tbl_temporaryx00.data[x00].shipments_code;
                xnumber = "454" + tbl_temporary1.data[0].tms_transport_code;
              }
              ...
              let tbl_temporaryx01 = await pgConn.get(
                dbPrefix + lic_code,
                scriptx01,
                config.connectionString(),
              );
              ...
              if (!tbl_temporaryx01.code) {
                if (tbl_temporaryx01.data.length > 0) {
                  ...
                  xlstart = moment(tbl_temporaryx01.data[0].loading_start_dt)
                    .add("Hours", 0)
                    .format("YYYY-MM-DDTHH:mm:ss");
                  xlend = moment(tbl_temporaryx01.data[0].loading_end_dt)
                    .add("Hours", 0)
                    .format("YYYY-MM-DDTHH:mm:ss");
                ...
                console.log(
                  job_code,
                  "เกิดข้อผิดพลาดในตอนส่งข้อมูล TMP (Get depot)",
                );
                return false;
              }
              ...
              let tbl_temporaryx02 = await pgConn.get(
                dbPrefix + lic_code,
                scriptx02,
                config.connectionString(),
              );
              ...
              if (!tbl_temporaryx02.code) {
                if (tbl_temporaryx02.data.length > 0) {
                  ...
                  xunstart = moment(tbl_temporaryx02.data[0].unloading_start_dt)
                    .add("Hours", 0)
                    .format("YYYY-MM-DDTHH:mm:ss");
                  xunend = moment(tbl_temporaryx02.data[0].unloading_end_dt)
                    .add("Hours", 0)
                    .format("YYYY-MM-DDTHH:mm:ss");
              ...
              let tbl_temporaryx03 = await pgConn.get(
                dbPrefix + lic_code,
                scriptx03,
                config.connectionString(),
              );
              ...
              if (!tbl_temporaryx03.code) {
                if (tbl_temporaryx03.data.length > 0) {
                  ...
                  for (
                    var itm = 0;
                    itm <= tbl_temporaryx03.data.length - 1;
                    itm++
                  ) {
                    var xtemplate_id =
                      tbl_temporaryx03.data[itm].itm_material_number;
                    ...
                    let tbl_temporaryx04 = await pgConn.get(
                      dbPrefix + lic_code,
                      scriptx04,
                      config.connectionString(),
                    );
                    if (!tbl_temporaryx04.code) {
                      if (tbl_temporaryx04.data.length > 0) {
                        ...
                        console.log(
                          job_code,
                          "ไม่พบข้อมูล Job เพื่อส่งไปยัง TMP",
                        );
                        xresult = false;
                        return xresult;
                      }
                  ...
                  if (xproduction && lic_code == "prw02") {
                    ...
                    let xconfig = {
                      ...
                      headers: {
                        "Content-Type": "application/xml",
                        Authorization:
                          "Basic SW50ZXJmYWNlQDYyNDc0NTpXc0A2NTQzMjE=",
                      },
                      data: xdata,
                    };
                    ...
                    await axios
                      ...
                      .then(async (response) => {
                        ...
                        if (response.data.success == true) {
                          console.log(
                            job_code,
                            "postJob2TmpWithShipment TMP Complete",
                          );
                      ...
                      .catch(async (error) => {
                        ...
                        console.log(
                          job_code,
                          "เกิดข้อผิดพลาดในตอนส่งข้อมูล TMP",
                        );

                        var scriptx04 = `update tbl_job set transporeon_status = 'D', job_comment = 'ข้อมูลไม่ถูกต้อง ตรวจสอบชื่ออักขระพิเศษ' where job_code = '${job_code}'`;
                        let tbl_temporaryx04 = await pgConn.execute(
                          dbPrefix + lic_code,
                          scriptx04,
                          config.connectionString(),
                        );
...
exports.deleteJob2TmpWithShipment = async (lic_code, job_code) => {
  try {
    ...
    if (!tbl_temporary1.code) {
      ...
      debugger;
      if (tbl_temporary1.data.length > 0) {
        var tms_transport_code =
          "454" + tbl_temporary1.data[0].tms_transport_code;
        debugger;
        console.log("xproduction", xproduction);
          ...
          await axios
            ...
            .then((response) => {
              ...
              if (response.data.success == true) {
                ...
                console.log(
                  job_code,
                  "เกิดข้อผิดพลาดในตอนส่งข้อมูล TMP, Delete TMP Reject",
                );
                return false;
              }
            })
  ...
  try {
    ...
    if (!tbl_temporary1.code) {
      if (tbl_temporary1.data.length > 0) {
        ...
        let tbl_temporary1x1 = await pgConn.get(
          dbPrefix + lic_code,
          script1,
          config.connectionString(),
        );
            ...
            for (var r00 = 0; r00 <= tbl_temporary2.data.length - 1; r00++) {
              ...
              if (!tbl_temporaryx00.code) {
                if (tbl_temporaryx00.data.length == 0) {
                  ...
                  let tbl_temporaryx00xx23 = await pgConn.get(
                    dbPrefix + lic_code,
                    scriptx00,
                    config.connectionString(),
                  );
                  if (!tbl_temporaryx00xx23.code) {
                    if (tbl_temporaryx00xx23.data.length > 0) {
                      ...
                      tbl_temporaryx00 = await pgConn.get(
                        dbPrefix + lic_code,
                        scriptx00,
                        config.connectionString(),
                      );
                      if (!tbl_temporaryx00.code) {
                        if (tbl_temporaryx00.data.length == 0) {
                          console.log(
                            job_code,
                            "เกิดข้อผิดพลาดในตอนส่งข้อมูล TMP (Get petrol (Special))",
                          );
                          return "";
                        }
                      }
                ...
                console.log(
                  job_code,
                  "เกิดข้อผิดพลาดในตอนส่งข้อมูล TMP (Get petrol)",
                );
                return "";
              }
              ...
              for (
                var x00 = 0;
                x00 <= tbl_temporaryx00.data.length - 1;
                x00++
              ) {
                var xitem = "";
                var xshipments_code = "";
                ...
                var xgsap_order_status =
                  tbl_temporaryx00.data[x00].gsap_order_status;
                var xgsap_order_number =
                  tbl_temporaryx00.data[x00].gsap_order_number;
                var xgsap_order_type_code =
                  tbl_temporaryx00.data[x00].gsap_order_type_code;
                var xgsap_shipments_number =
                  tbl_temporary1.data[0].gsap_shipments_number;
                ...
                if (
                  tbl_temporary1.data[0].veh_type_code == "veht-1749028886915"
                ) {
                  xvehicle_id = "vehicleTruckTrailerCombination";

                  if (tbl_temporary1.data[0].veh_sub_license_number != "") {
                    if (
                      tbl_temporary1.data[0].veh_sub_license_number != "N/A"
                    ) {
                      xlicence_plate_second_trailer =
                        tbl_temporary1.data[0].veh_sub_license_number.replace(
                          "-",
                ...
                if (
                  tbl_temporaryx00.data[x00].ord_type_code ==
                  "otyp-9999999999999"
                ) {
                  xgsap_order_status =
                    tbl_temporaryx00.data[x00].gsap_order_status;
                  ...
                  if (xcreate_order == true) {
                    xshipments_code =
                      "693" + tbl_temporaryx00.data[x00].shipments_code;
                  } else {
                    xshipments_code =
                      "692" + tbl_temporaryx00.data[x00].shipments_code;
                  }
                ...
                if (!tbl_temporaryx02.code) {
                  if (tbl_temporaryx02.data.length > 0) {
                    ...
                    xunloading_name = tbl_temporaryx02.data[0].ptrl_number;
                    xunstart = moment(
                      tbl_temporaryx02.data[0].unloading_start_dt,
                    )
                      .add("Hours", 0)
                      .format("YYYY-MM-DDTHH:mm:ss");
                    xunend = moment(tbl_temporaryx02.data[0].unloading_end_dt)
                ...
                if (!tbl_temporaryx03.code) {
                  if (tbl_temporaryx03.data.length > 0) {
                    var xitemuse = [
                      { itm_code: "", compartment_number: "", tank_number: "" },
                    ];
                    ...
                    for (
                      ...
                      if (xitemfilter.length == 0) {
                        ...
                        xitemuse.push({
                          itm_code: xitm_code,
                          compartment_number: xcompartment_number,
                          tank_number: xtank_number,
                        });
                        ipos += 1;
                        xitem += `<item>
                                                        <template_id>${xtemplate_id}</template_id>
...
exports.postCloseDischargedJob2TmpWithXml = async (
  lic_code,
  job_code,
  xdata,
) => {
    ...
    if (xproduction && lic_code == "prw02") {
      ...
      try {
        ...
        if (response.data.success == true) {
          console.log(
            job_code,
            "postCloseDischargedJob2TmpWithXml TMP Complete",
          );
          var scriptx03 = `update tbl_job set job_comment = 'TMP Complete' where job_code = '${job_code}';`;
          let tbl_temporaryx03 = await pgConn.execute(
            dbPrefix + lic_code,
            scriptx03,
            config.connectionString(),
          );
...
exports.postSyncVMIOrder_BK = async (lic_code) => {
  try {
    ...
    try {
      ...
      params.append(
        "client_secret",
        "Ikr7Fdnh2Z1DLeIL1ncq0xO99OHhH4YltuxviiWVzHIMpoQTtUzyWFKhXzCYOPTV",
      );
      params.append("scope", "ais-ds-ts-hamlet-prv");
      params.append("grant_type", "client_credentials");

      await axios
        .post(xurl_prod, params, {
          headers: {
        ...
        .then(async (response) => {
          ...
          await axios
            .post(xutl_order_prod, JSON.stringify(data), {
              headers: {
                  ...
                  for (var x = 0; x <= response2.data.length - 1; x++) {
                    ...
                    if (!tbl_temporary.code) {
                      if (tbl_temporary.data.length > 0) {
                        ...
                        let dpo_number =
                          response2.data[x].depotCode == undefined
                            ? ""
                            : response2.data[x].depotCode;
                        let dpo_code = "";
                        let xdpo_information = await this.getDepotInformation(
                          lic_code,
                          dpo_number,
                        );
                        //debugger
                        ...
                        let item_quantity = 0;
                        let xitm_information = await this.getItemInformation(
                          lic_code,
                          itm_material_number,
                        );
                        itm_code = xitm_information[0].itm_code;
                        ...
                        if (dpo_code == "" && ptrl_code != "") {
                          xdpo_information =
                            await this.getDepotFromPetrolInformation(
                              lic_code,
                              ptrl_code,
                            );
                          dpo_code = xdpo_information[0].dpo_code;
                        ...
                        try {
                          average_daily_sales = parseFloat(
                            response2.data[x].averageDailySales,
                          );
                        } catch (error) {
                        ...
                        if (ord_code != "") {
                          ...
                          let tbl_temporary0x02 = await pgConn.get(
                            dbPrefix + lic_code,
                            script0,
                            config.connectionString(),
                          );
                        ...
                        //debugger
                        let ptrl_code = xcustomer_information[0].ptrl_code;
                        let ord_customer_code =
                          xcustomer_information[0].ptrl_code;
                        let ord_customer_name =
                          xcustomer_information[0].ptrl_desc;
                        let ord_customer_number =
                          xcustomer_information[0].ptrl_number;
                        let petrol_group_code =
                          xcustomer_information[0].ptrl_group_code;
                        let ptrl_tank_code =
                          xcustomer_information[0].ptrl_tank_code;
...
exports.formatAuditLogs = (dbData) => {
  ...
  for (let i = 0; i < rawData.length; i++) {
    ...
    if (parsedBody) {
      ...
      if (
        Array.isArray(bodyContent.changes) &&
        bodyContent.changes.length > 0
      ) {
